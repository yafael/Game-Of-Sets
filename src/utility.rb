...
class Utility
  ...
  # +cardTwo+:: Second card that might form a set
  # +cardThree+:: Third card that might form a set.
  private def self.checkColor? (one, two, three)
  ...
  # +cardTwo+:: Second card that might form a set
  # +cardThree+:: Third card that might form a set.
  private  def self.checkFill? (one, two, three)
  ...
  # +cardTwo+:: Second card that might form a set
  # +cardThree+:: Third card that might form a set.
  private def self.checkSymbol? (one, two, three)
  ...
  # +cardTwo+:: Second card that might form a set
  # +cardThree+:: Third card that might form a set.
  private def self.checkNumber? (one, two, three)
